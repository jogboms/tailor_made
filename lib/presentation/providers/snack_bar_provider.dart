...
class SnackBarProvider {
  ...
  void info(String value, {Duration? duration}) {
    ...
    show(
      value,
      leading: const Icon(Icons.info, color: AppColors.primary, size: 24),
      ...
      SnackBar(
        ...
        content: Row(
          children: <Widget>[
            ...
            Expanded(child: Text(value, style: appFontMedium(14.0, color))),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        ...
        if (content != null)
          Expanded(
            child: DefaultTextStyle(style: appFontColor(Colors.white), child: content!),
          ),
      ],
    );
  }

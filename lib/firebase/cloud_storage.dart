...
class CloudStorage {
  ...
  static StorageReference createContactImage([String id]) => contacts.child('${id ?? uuid()}.jpg');
  static StorageReference createReferenceImage([String id]) => references.child('${id ?? uuid()}.jpg');
}

...
class TMListTile extends StatelessWidget {
  const TMListTile({Key key, this.icon, this.color, this.title, this.onPressed}) : super(key: key);
...
class TMGridTile extends StatelessWidget {
  const TMGridTile({this.icon, this.color, this.title, this.subTitle, this.onPressed});

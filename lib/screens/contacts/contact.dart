...
const _TABS = ["Jobs", "Gallery", "Payments"];
              ...
              return TabBarView(
                children: [
                  ...
                  _TabView(
                    ...
                    child: GalleryGridWidget(contact: _contact, jobs: viewModel.selectedJobs),
                  ),
                  _TabView(
                    name: _TABS[2].toLowerCase(),
                    child: PaymentsListWidget(contact: _contact, jobs: viewModel.selectedJobs),
                  ),
                ],
              );
            }),
...
class _TabView extends StatelessWidget {
  const _TabView({Key key, @required this.name, @required this.child}) : super(key: key);
